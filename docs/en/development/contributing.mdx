...
<AccordionGroup>
  <Accordion icon="github" title="Fork and Clone">
    ...
    3. **Add upstream remote**:
       ```bash
       git remote add upstream https://github.com/LeonAI-DO-YLCS/metamcp.git
       ```
  </Accordion>
...
<CardGroup cols={1}>
  <Card title="Start Contributing" icon="rocket" href="https://github.com/LeonAI-DO-YLCS/metamcp/issues">
