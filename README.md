...
```bash
git clone https://github.com/LeonAI-DO-YLCS/metamcp.git
cd metamcp
cp example.env .env
docker compose up -d
```
...
For more details and alternative approaches, see [issue #76](https://github.com/LeonAI-DO-YLCS/metamcp/issues/76#issuecomment-3046707532).
